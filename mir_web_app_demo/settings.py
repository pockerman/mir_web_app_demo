"""
Django settings for mir_web_app_demo project.
...
SECRET_KEY = 'django-insecure-70$hk9urv-5j0yoe4t1_z4748%5su=&)#138rw*_dk=6fae$68'
...
ROOT_URLCONF = 'mir_web_app_demo.urls'
...
WSGI_APPLICATION = 'mir_web_app_demo.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_FILES = '%s/%s' % (BASE_DIR, STATIC_URL)
STATIC_ROOT = ''

# don't specify it for the moment
# as we use VITERBI_PATHS_FILES_ROOT
MEDIA_URL = '/surveys/'
MEDIA_ROOT = '%s/surveys/' % BASE_DIR
